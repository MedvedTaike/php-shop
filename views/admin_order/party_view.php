        ...
        <div class="row">          
            <div class="breadcrumbs">
                <ol class="breadcrumb">
                    ...
                    <li><a href="/admin/order/party">Активные партии</a></li>
                    <li class="active">Просмотр заказов партии № <?php echo $id; ?></li>
                </ol>
            </div>
            <h4>Список заказов партии №<span id="party"><?= $id; ?></span></h4>
            <table class="table-bordered  table-striped table">
                ...
                <?php foreach ($ordersList as $order): ?>
                    <tr>
                        ...
                        <td class="delete"><a href="#" id="<?php echo $order['id']; ?>" title="Удалить"><i class="fa fa-times"></i></a></td>
            ...
            <a href="/admin/print/view/<?= $id; ?>" class="btn btn-success"> Накладные</a>
            <a href="/admin/print/seller/<?= $id; ?>" class="btn btn-success"> Накл. поставщик</a>
            <a href="/admin/print/driver/<?= $id; ?>" class="btn btn-success"> Накл. водитель</a>
            <a href="/admin/print/deliver/<?= $id; ?>" class="btn btn-success"> Дата отправки</a>
            <a href="/admin/print/clear/<?= $id; ?>" class="btn btn-success"> Отправлено</a>
            <a href="/postav/review" class="btn btn-success"> Поставщики</a>
        </div>
    </div>
</section>
<br><br>
...
<script>
    $(function(){
        $('td.delete a').click(function(i){
            i.preventDefault();
            var id = $(this).attr('id');
            var party = $('#party').text();
            $.ajax({
                url:'/admin/print/ajax',
                method:'POST',
